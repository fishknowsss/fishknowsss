...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com/?font=Inter&weight=500&size=18&pause=2200&color=5C5470&center=true&vCenter=true&width=980&lines=UI%2FUX+%C2%B7+Interaction+Design+%C2%B7+Product+Engineering+%C2%B7+New+Media+Practice;Local-first+Desktop+Tools+%C2%B7+AI+Video+Workflows+%C2%B7+Studio+Systems;Digital+Audiovisual+Interaction+%C2%B7+Philosophy+%C2%B7+New+Media+Art;Designing+between+function%2C+perception%2C+media%2C+and+expression." alt="Typing SVG" />
</p>
...
🪪 Research-oriented design student &nbsp;|&nbsp; 🎯 UI/UX · Interaction · Product Engineering &nbsp;|&nbsp; 🌏 Heading to Japan
